...
class Factor(FactorBase):
    ...
    def factor_definition(self):
        ...
        x_1 = self.calculator.Rank(self.calculator.Sum(self.calculator.Delay(adjClose, 5),10)/10)
        x_2 = self.calculator.Corr(adjClose, Volume, 10)
        x_3 = self.calculator.Rank(self.calculator.Corr(self.calculator.Sum(adjClose,5), self.calculator.Sum(adjClose,10), 6)) 
        
        factor = -x_1*x_2*x_3/self.calculator.Std(adjClose,9)
